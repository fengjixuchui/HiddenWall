...
* Communication by device char (different of anothers rootkits that use signal and ioctl)
* Random junk code by binary that turns each generated binary unique 
