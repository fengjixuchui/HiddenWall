...
def banner():
 ...
 cyan = '\033[36m'
 orange = '\033[33m'
 print("\n\t"+yellow+"...:::-> HiddenWall <-:::...\n"+cyan+" Linux kernel module generator for hidden custom firewall in kernel land\n") 
 print("\t  version 0.45, coded by CoolerVoid\n")
 print("                    ,-,-")      
 print("                   / / |")      
 print(" ,-'             _/ / / ")      
 print("(-_          _,-' `Z_/  ")        
...
# Junk code generator
 source = source.replace("CODE_GEN_FUNC_NAME1", random_function_name())
 source = source.replace("CODE_GEN_FUNC_NAME2", random_function_name())
 source = source.replace("CODE_GEN_FUNC_NAME3", random_function_name())
 source = source.replace("CODE_GEN_FUNC_NAME4", random_function_name())
 source = source.replace("CODE_GEN_FUNC_NAME5", random_function_name())
 source = source.replace("JUNK_CODE_1", code_junk_gen())
 source = source.replace("JUNK_CODE_2", code_junk_gen())
 source = source.replace("JUNK_CODE_3", code_junk_gen())
...
# save output
 ...
 print (cyan+"Python Script end, please look the output your custom kernel module at directory output/\n"+reset)
